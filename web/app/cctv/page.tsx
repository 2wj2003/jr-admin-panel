...
import { CCTVFaqs } from "@components/cctv-faq";
...
export default async function CCTV() {
  ...
  return (
    <>
      <section className="relative bg-gradient-to-b from-[#1877F2] to-[#104FA1]">
        <div className="container mx-auto px-4 md:px-8 lg:px-10 bg-no-repeat bg-contain bg-top md:bg-none md:bg-left-top md:bg-[length:600px] bg-[url('https://s3.ap-southeast-1.amazonaws.com/jr.co.th/bg_element_8cb080f584.svg')]">
          <div className="flex flex-col gap-10 md:grid md:grid-cols-2">
            <div className="flex flex-col gap-6 md:col-span-1 pt-8 md:pt-16 pb-0 md:pb-16">
              <div className="text-white text-center px-6 pt-16 md:pt-8 flex flex-col gap-2">
                ...
                <h1 className="block text-4xl font-bold">กล้องวงจรปิด</h1>
                <span className="block text-2xl">
                  ทุกสถานที่ ดูแลต้นจนจบ ครบวงจร
                </span>
              </div>
              <div className="text-base text-white text-center">
                ด้วยทีมช่างมืออาชีพและประสบการณ์มากกว่า 30 ปี
                และติดตั้งมาแล้วมากกว่า 100,000 สถานที่
              </div>
      ...
      <section className="overflow-hidden container mx-auto px-4 py-8 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gab-4">
          <div className="col-span-1 relative w-full md:max-w-lg items-center object-center mx-auto mt-auto my-auto mb-8 md:mb-auto">
            {/* <Image
              src="https://s3.ap-southeast-1.amazonaws.com/jr.co.th/landing_1fdebc80ff.png"
              width="500"
              height="500"
            ...
            <iframe
              ...
              src="https://www.youtube.com/embed/WITnya1DYXw"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 ">
          ...
          <div className="col-span-1 relative w-full md:max-w-lg items-center object-center mx-auto mt-auto my-auto">
            ...
            <iframe
              ...
              // height="315"
              className="aspect-video w-full"
              src="https://www.youtube.com/embed/UcfSQTrfoUE"
              title="YouTube video player"
              // frameborder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
              // allowfullscreen
      ...
      <section className="container mx-auto px-0 md:px-8 lg:px-10 py-8 flex flex-col gap-10">
        ...
        <ul className="grid grid-cols-4 md:grid-cols-6 gap-4 place-items-center items-center justify-center">
          {brands?.data?.map((b) => (
            <li
              key={b.id}
              className="relative col-span-1 aspect-[28/16] w-full"
            >
...
export const metadata: Metadata = {
  title: "กล้องวงจรปิด และกล้องวงจรปิดไร้สาย รับติดตั้งทั่วประเทศไทย",
  description:
    "ชุดกล้องวงจรปิดไร้สายดูผ่านมือถือได้ ราคาเริ่มต้นหลักพัน พร้อมติดตั้งโดยทีมช่างมืออาชีพ การันตีคุณภาพกว่า 35 ปี",
  openGraph: {
    type: "article",
    url: "https://www.jr.co.th/cctv",
    siteName: "jr.co.th",
    title: "กล้องวงจรปิด และกล้องวงจรปิดไร้สาย รับติดตั้งทั่วประเทศไทย",
    description:
      "ชุดกล้องวงจรปิดไร้สายดูผ่านมือถือได้ ราคาเริ่มต้นหลักพัน พร้อมติดตั้งโดยทีมช่างมืออาชีพ การันตีคุณภาพกว่า 35 ปี",
  ...
  alternates: {
    canonical: "https://www.jr.co.th/cctv",
  },
  robots: {
    follow: true,
    index: true,
